...
return [
    ...
    'members' => [[], ['_controller' => 'App\\Controller\\HomeController::members'], [], [['text', '/members']], [], []],
    'member' => [['id'], ['_controller' => 'App\\Controller\\HomeController::user'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/members']], [], []],
    'addMember' => [[], ['_controller' => 'App\\Controller\\HomeController::addMember'], [], [['text', '/addMember']], [], []],
    'updateMember' => [['id'], ['_controller' => 'App\\Controller\\HomeController::editMember'], [], [['text', '/update'], ['variable', '/', '[^/]++', 'id', true], ['text', '/member']], [], []],
    'deleteMember' => [['id'], ['_controller' => 'App\\Controller\\HomeController::deleteMember'], [], [['text', '/delete'], ['variable', '/', '[^/]++', 'id', true], ['text', '/member']], [], []],
