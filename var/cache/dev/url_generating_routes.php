...
return [
    ...
    'presentation' => [[], ['_controller' => 'App\\Controller\\HomeController::presentation'], [], [['text', '/presentation']], [], []],
    'equipe' => [[], ['_controller' => 'App\\Controller\\HomeController::equipe'], [], [['text', '/equipe']], [], []],
    ...
    'addAddress' => [['id'], ['_controller' => 'App\\Controller\\HomeController::addAddress'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/addAddress']], [], []],
    'updateAddress' => [['id'], ['_controller' => 'App\\Controller\\HomeController::editAddress'], [], [['text', '/updateAddress'], ['variable', '/', '[^/]++', 'id', true], ['text', '/profile']], [], []],
    'deleteAddress' => [['id'], ['_controller' => 'App\\Controller\\HomeController::deleteAddress'], [], [['text', '/deleteAddress'], ['variable', '/', '[^/]++', 'id', true], ['text', '/profile']], [], []],
    'addPayment' => [['id'], ['_controller' => 'App\\Controller\\HomeController::addPayment'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/addPayment']], [], []],
    'updatePayment' => [['id'], ['_controller' => 'App\\Controller\\HomeController::editPayment'], [], [['text', '/updatePayment'], ['variable', '/', '[^/]++', 'id', true], ['text', '/profile']], [], []],
    'deletePayment' => [['id'], ['_controller' => 'App\\Controller\\HomeController::deletePayment'], [], [['text', '/deletePayment'], ['variable', '/', '[^/]++', 'id', true], ['text', '/profile']], [], []],
